 ...
 * generated in the org.nameapi.client.services.validator.placeholdernamedetector.wsdl package. 
...
public class ObjectFactory {
    ...
    private final static QName _InternalServerErrorWebServiceException_QNAME = new QName("http://placeholdernamedetector.validator.services.v4_0.soap.server.nameapi.org/", "InternalServerErrorWebServiceException");
    private final static QName _InvalidInputWebServiceException_QNAME = new QName("http://placeholdernamedetector.validator.services.v4_0.soap.server.nameapi.org/", "InvalidInputWebServiceException");
    private final static QName _CheckPersonResponse_QNAME = new QName("http://placeholdernamedetector.validator.services.v4_0.soap.server.nameapi.org/", "checkPersonResponse");
    private final static QName _CheckPerson_QNAME = new QName("http://placeholdernamedetector.validator.services.v4_0.soap.server.nameapi.org/", "checkPerson");
    private final static QName _AccessDeniedWebServiceException_QNAME = new QName("http://placeholdernamedetector.validator.services.v4_0.soap.server.nameapi.org/", "AccessDeniedWebServiceException");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.nameapi.client.services.validator.placeholdernamedetector.wsdl
     * 
     */
    ...
    /**
     * Create an instance of {@link SoapPlaceholderNameResult }
     * 
     */
    public SoapPlaceholderNameResult createSoapPlaceholderNameResult() {
        return new SoapPlaceholderNameResult();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://placeholdernamedetector.validator.services.v4_0.soap.server.nameapi.org/", name = "InternalServerErrorWebServiceException")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://placeholdernamedetector.validator.services.v4_0.soap.server.nameapi.org/", name = "InvalidInputWebServiceException")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://placeholdernamedetector.validator.services.v4_0.soap.server.nameapi.org/", name = "checkPersonResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://placeholdernamedetector.validator.services.v4_0.soap.server.nameapi.org/", name = "checkPerson")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://placeholdernamedetector.validator.services.v4_0.soap.server.nameapi.org/", name = "AccessDeniedWebServiceException")
