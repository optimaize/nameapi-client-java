 ...
 * generated in the org.nameapi.client.services.validator.randomtyping.personrandomtypingdetector.wsdl package. 
...
public class ObjectFactory {
    ...
    private final static QName _CheckPerson_QNAME = new QName("http://randomtyping.validator.services.v4_0.soap.server.nameapi.org/", "checkPerson");
    private final static QName _CheckPersonResponse_QNAME = new QName("http://randomtyping.validator.services.v4_0.soap.server.nameapi.org/", "checkPersonResponse");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.nameapi.client.services.validator.randomtyping.personrandomtypingdetector.wsdl
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://randomtyping.validator.services.v4_0.soap.server.nameapi.org/", name = "checkPerson")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://randomtyping.validator.services.v4_0.soap.server.nameapi.org/", name = "checkPersonResponse")
