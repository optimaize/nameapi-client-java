 ...
 * generated in the org.nameapi.client.services.email.emailnameparser2.wsdl package. 
...
public class ObjectFactory {
    ...
    private final static QName _Parse_QNAME = new QName("http://emailnameparser2.email.services.v4_0.soap.server.nameapi.org/", "parse");
    private final static QName _InternalServerErrorWebServiceException_QNAME = new QName("http://emailnameparser2.email.services.v4_0.soap.server.nameapi.org/", "InternalServerErrorWebServiceException");
    private final static QName _InvalidInputWebServiceException_QNAME = new QName("http://emailnameparser2.email.services.v4_0.soap.server.nameapi.org/", "InvalidInputWebServiceException");
    private final static QName _ParseResponse_QNAME = new QName("http://emailnameparser2.email.services.v4_0.soap.server.nameapi.org/", "parseResponse");
    private final static QName _AccessDeniedWebServiceException_QNAME = new QName("http://emailnameparser2.email.services.v4_0.soap.server.nameapi.org/", "AccessDeniedWebServiceException");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.nameapi.client.services.email.emailnameparser2.wsdl
     * 
     */
    ...
    /**
     * Create an instance of {@link SoapEmailNameParserResult2 }
     * 
     */
    public SoapEmailNameParserResult2 createSoapEmailNameParserResult2() {
        return new SoapEmailNameParserResult2();
    }
...
//    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://emailnameparser2.email.services.v4_0.soap.server.nameapi.org/", name = "parse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://emailnameparser2.email.services.v4_0.soap.server.nameapi.org/", name = "InternalServerErrorWebServiceException")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://emailnameparser2.email.services.v4_0.soap.server.nameapi.org/", name = "InvalidInputWebServiceException")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://emailnameparser2.email.services.v4_0.soap.server.nameapi.org/", name = "parseResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://emailnameparser2.email.services.v4_0.soap.server.nameapi.org/", name = "AccessDeniedWebServiceException")
